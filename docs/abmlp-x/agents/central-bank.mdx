...
def step(self):
    ...
    Get Producer expectations and 'velocity' and 'acceleration' of new money bills issued.
    """
    # self.base_rate = policy_interest_rate(r.lrange("bills:velocity", 0, -1),
    #                                       r.lrange("bills:acceleration", 0, -1),
    #                                       producer.average_income_expectation)
