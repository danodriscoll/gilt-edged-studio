...
# Use the interest rate from the previous step to calculate the price of a
# long-term bond in this step.
self.bond_price = zero_division(self.coupon_rate, central_bank.base_rate)

# Use the bond price in this step to calculate the long-term rate of interest
